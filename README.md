...
* multirobot_map_merge: Customized fork on [Github](https://github.com/jvdgoltz/m-explore) and as a [ROS Package](http://wiki.ros.org/multirobot_map_merge)
